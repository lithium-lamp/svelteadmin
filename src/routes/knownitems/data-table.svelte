<script lang="ts">
    ...
    const hidableCols = ["created_at", "serial_number", "long_name", 
      "short_name", "tags", "item_type", "measurement", "container_size"
      , "version"];
</script>
            ...
            <Table.Row>
              {#each headerRow.cells as cell (cell.id)}
                ...
                >
                    ...
                    {:else if cell.id === "created_at" || cell.id === "serial_number"
                    || cell.id === "long_name" || cell.id === "short_name"
                    || cell.id === "tags" || cell.id === "item_type"
                    || cell.id === "measurement" || cell.id === "container_size"}
